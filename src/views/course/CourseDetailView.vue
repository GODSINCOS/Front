<template>
  <el-card>
    ...
    <el-descriptions title="基本信息" :column="2" border>
      ...
      <el-descriptions-item label="作者">{{ course.author }}</el-descriptions-item>
      <el-descriptions-item label="创建时间">
        {{ course.createTime ? dayjs(course.createTime).format('YYYY-MM-DD HH:mm:ss') : '暂无' }}
      </el-descriptions-item>
      <el-descriptions-item label="简介">{{ course.summary }}</el-descriptions-item>
      <el-descriptions-item label="排序">{{ course.orderNum }}</el-descriptions-item>
    </el-descriptions>
    ...
    <div class="mt-4">
      <h4>课程内容：</h4>
      <div class="rich-text-content" v-html="course.content || '暂无内容'" />
    </div>
  </el-card>
</template>
